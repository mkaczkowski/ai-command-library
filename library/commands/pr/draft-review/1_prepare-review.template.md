...
- **Major:** Non-blocking but requires follow-up before release (behaviour gaps, missing test coverage, UX/perf regressions).
...
2. Ground feedback in evidence from the diff, context file, or existing codebase.
